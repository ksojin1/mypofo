    ...
    return (
        <div className={styles.wrap}>
            ...
            <div className={styles.cont_Div}>
                ...
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff3.png`}/></div>
                <p>
            ...
            <div className={styles.cont_Div}>
                <h1>📍게시글 상세보기📍</h1>
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff4.png`}/></div>
                <p>
                ...
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff5.png`}/></div>
                <p>
            ...
            <div className={styles.cont_Div}>
                <h1>📍사진 미리보기📍</h1>
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff8.png`}/></div>
                <p>
            ...
            <div className={styles.cont_Div}>
                <h1>📍비밀번호 찾기📍</h1>
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff6.png`}/></div>
                <div className={styles.img_Div}><img src={`${process.env.PUBLIC_URL}/image/myff7.png`}/></div>
                <p>
